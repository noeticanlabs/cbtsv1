...
# Optimized setup
from scripts.nsc_runtime_min import make_rhs_callable
from src.core.gr_core_fields import det_sym6
from config.gr_geometry_nsc import IDX_XX, IDX_YY, IDX_ZZ
