...
Usage:
    from src.nsc.compat import NSC_GR  # Old style
    from src.nsc.domains.geometry.gr import NSC_GR  # New style
"""
...
from src.nsc.domains.algebra.tensor import NSC_tensor as alg_types

# Old: from nsc.ledger_gates
# New: from nsc.models.ledger import NSC_ledger
from src.nsc.models.ledger import NSC_ledger as ledger_gates

# Old: from nsc.stencils
# New: from nsc.domains.numerical.stencils import NSC_stencils
from src.nsc.domains.numerical.stencils import NSC_stencils as stencils

# Old: from nsc.exec_vm
# New: from nsc.models.exec.vm import NSC_VM
from src.nsc.models.exec.vm import NSC_VM

# Old: from nsc.quadrature
# New: from nsc.domains.numerical.quadrature
from src.nsc.domains.numerical.quadrature import NSC_quadrature as quadrature
...
def __getattr__(name):
    ...
    if name in deprecation_warnings:
        ...
        if name == 'NSC_GR':
            from src.nsc.domains.geometry.gr import NSC_GR
            return NSC_GR
        elif name == 'NSC_NS':
            from src.nsc.domains.fluids.navier_stokes import NSC_NS
            return NSC_NS
        elif name == 'NSC_YM':
            from src.nsc.domains.geometry.ym import NSC_YM
            return NSC_YM
        elif name == 'NSC_Time':
            from src.nsc.models.ledger import NSC_ledger
            from src.nsc.models.exec.vm import NSC_VM as NSC_exec # Changed import for NSC_exec
...
class _CompatModule:
    ...
    @property
    def alg_types(self):
        from src.nsc.domains.algebra.tensor import NSC_tensor
        return NSC_tensor
    ...
    @property
    def stencils(self):
        from src.nsc.domains.numerical.stencils import NSC_stencils
        return NSC_stencils
    ...
    @property
    def quadrature(self):
        from src.nsc.domains.numerical.quadrature import NSC_quadrature
