#!/usr/bin/env python3
"""
Runner for TGS.nllc GR solver test.
Compiles and executes TGS.nllc using the GR Host API.
"""
...
def main():
    ...
    # Save receipts
    with open('tgs_nllc_receipts.json', 'w') as f:
        json.dump(receipts, f, indent=2)

    print("Receipts saved to tgs_nllc_receipts.json")
